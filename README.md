...
[![build-ublue](https://github.com/knownbone/blue-bone/actions/workflows/build.yml/badge.svg)](https://github.com/knownbone/blue-bone/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `knownbone/blue-bone` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/knownbone/blue-bone:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/knownbone/blue-bone:latest
  ```
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/knownbone/blue-bone:20230403
```
